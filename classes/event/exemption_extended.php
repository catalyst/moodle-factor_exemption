 ...
 */
class exemption_extended extends \core\event\base {
     ...
     *
     * @return exemption_extended the exemption added event object.
    ...
    public static function get_name() {
        return get_string('event:exemptionextended', 'factor_exemption');
    }
}
